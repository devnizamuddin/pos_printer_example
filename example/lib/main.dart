                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        String url =
                            'https://upload.wikimedia.org/wikipedia/en/thumb/3/3f/Teletalk_Bangladesh_Limited.svg/640px-Teletalk_Bangladesh_Limited.svg.png';
...
Future<List<int>> _customEscPos() async {
  ...
  bytes += generator.text('Nazmul + Keya');
  ...
  bytes += generator.text('Nazmul + Keya 14 Jun 2023',
